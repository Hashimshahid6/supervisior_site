                        ...
                        <form action="{{route('sections.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <div class="col-4">
                                    ...
                                    <input id="button_text" name="button_text" placeholder="Enter Button Text" type="text" class="form-control">
                                    @error('button_text')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-4">
                                    ...
                                    <input id="button_link" name="button_link" placeholder="Enter Button Link" type="text" class="form-control">
                                    @error('button_link')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-4">
                                    ...
                                    <input id="order" name="order" placeholder="Enter Order" type="number" class="form-control">
                                    @error('order')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
