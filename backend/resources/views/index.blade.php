                            ...
                            <div class="mx-n4" data-simplebar style="max-height: 205px;">
                                <div class="popular-product-box rounded my-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0 text-end ms-3">
                                            <h5 class="mb-1"><a href="" class="font-size-15 text-body">$62300.00</a>
                                            </h5>
                                ...
                                <div class="popular-product-box rounded my-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0 text-end ms-3">
                                            <h5 class="mb-1"><a href="" class="font-size-15 text-body">$25698.00</a>
                                            </h5>
                                ...
                                <div class="popular-product-box rounded my-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0 text-end ms-3">
                                            <h5 class="mb-1"><a href="" class="font-size-15 text-body">$64351.00</a>
                                            </h5>
                                ...
                                <div class="popular-product-box rounded my-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0 text-end ms-3">
                                            <h5 class="mb-1"><a href="" class="font-size-15 text-body">$96485.00</a>
                                            </h5>
                                ...
                                <div class="popular-product-box rounded my-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0 text-end ms-3">
                                            <h5 class="mb-1"><a href="" class="font-size-15 text-body">$56230.00</a>
                                            </h5>
