                        ...
                        <div class="mx-n3 px-3" data-simplebar style="max-height: 580px;">
                            <div class="blog-post">
                                ...
                                <div class="position-relative mt-3">
                                    <img src="{{ URL::asset('build/images/post-1.jpg') }}" alt=""
                                        class="img-thumbnail">
                                </div>
                                <div class="pt-3">
                                    <div
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center g-0">
                            ...
                            <div class="col-sm-9">
                                <div class="progress mt-1" style="height: 6px;">
                                    <div class="progress-bar progress-bar bg-primary" role="progressbar" style="width: 72%"
                        ...
                        <div class="row align-items-center g-0 mt-3">
                            ...
                            <div class="col-sm-9">
                                <div class="progress mt-1" style="height: 6px;">
                                    <div class="progress-bar progress-bar bg-primary" role="progressbar" style="width: 45%"
                        ...
                        <div class="row align-items-center g-0 mt-3">
                            ...
                            <div class="col-sm-9">
                                <div class="progress mt-1" style="height: 6px;">
                                    <div class="progress-bar progress-bar bg-primary" role="progressbar" style="width: 68%"
                        ...
                        <div class="row align-items-center g-0 mt-3">
                            ...
                            <div class="col-sm-9">
                                <div class="progress mt-1" style="height: 6px;">
                                    <div class="progress-bar progress-bar bg-primary" role="progressbar" style="width: 78%"
                        ...
                        <div class="row align-items-center g-0 mt-3">
                            ...
                            <div class="col-sm-9">
                                <div class="progress mt-1" style="height: 6px;">
                                    <div class="progress-bar progress-bar bg-primary" role="progressbar" style="width: 63%"
                        ...
                        <div class="row align-items-center g-0 mt-3">
                            ...
                            <div class="col-sm-9">
                                <div class="progress mt-1" style="height: 6px;">
                                    <div class="progress-bar progress-bar bg-primary" role="progressbar" style="width: 48%"
                                        aria-valuenow="48" aria-valuemin="0" aria-valuemax="48">
                                    </div>
                                </div>
                            </div>
