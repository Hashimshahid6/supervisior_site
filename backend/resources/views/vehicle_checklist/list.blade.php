...
<body>
    ...
    <div class="row align-items-center">
        <div class="col-md-6">
            <div class="mb-3">
                <h5 class="card-title">Vehicle Checklist<span class="text-muted fw-normal ms-2">({{$VehicleChecklists->count()}})</span></h5>
            </div>
        </div>
        @if(auth()->user()->role == 'Employee')
        <div class="col-md-6">
            <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                <a href="{{route('vehicle_checklists.create')}}" class="btn btn-primary"><i class="bx bx-plus me-1"></i>Add New</a>
            </div>
        </div>
        @endif
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('vehicle_checklists.index') }}" method="GET">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="mb-3">
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3 mt-4">
                                    ...
                                    <a href="{{ route('vehicle_checklists.index') }}" class="btn btn-danger">Reset</a>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table align-middle">
                            ...
                            <tbody>
                                @foreach($VehicleChecklists as $checklist)
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item">
                                                @if(auth()->user()->role == 'Employee')
                                                <a href="{{ route('vehicle_checklists.edit', $checklist->id) }}" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="Edit" class="px-2 text-primary"><i
                                                        class="bx bx-pencil font-size-18"></i></a>
                                                @endif
                                                <a href="{{ route('vehicle_checklists.show', $checklist->id) }}" data-bs-toggle="tooltip"
