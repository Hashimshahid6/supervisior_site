...
class HeroSliderTwo extends Component{
    render(){
        ...
        let data = [
            ...
            {bgImg: 'slider11.jpg', sliderTitle: 'Build Your Dream With Passion', sliderSubtitle: 'Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusm tempor incididunt ut labore et dolore.', btnLink: 'contact-us'}
        ];
